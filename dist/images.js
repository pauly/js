...
(function (document, gU, round) {
  ...
  function mousedown(event, image, src, offset, x, y, text, url) {
    ...
    box.bottom = y;
    box.src = src;
    box[coords] = [round(box.left / image[widthString] * 100), // left as %
    ...
    if (box.text = prompt('Enter a note for this area')) {
      ...
      url = '/i/' + beginningOf(image.src) + '?_method=post' + '&text=' + box.text + '&' + coords + '[0]=' + box[coords][0] + '&' + coords + '[1]=' + box[coords][1] + '&' + coords + '[2]=' + box[coords][2] + '&' + coords + '[3]=' + box[coords][3];
